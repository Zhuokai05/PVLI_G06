export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // objetos y ataques del angel
    this.load.image('plume', 'assets/sprites/Player/Pluma.png');
    this.load.spritesheet('melee', 'assets/sprites/Player/Melee.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('melee_Ampliado', 'assets/sprites/Player/Melee_Ancho.png', { frameWidth: 128, frameHeight: 64 });
    ...
    // ============================================================
    // 3. ENEMIGOS BASICOS (MELEE)
    // ============================================================
    this.load.image('basicEnemyAngry', './assets/sprites/Enemigos/Enemigos_basicos/Fire.png');
    this.load.spritesheet('basicEnemyAngry_move', './assets/sprites/Enemigos/Enemigos_basicos/Fire_move.png', { frameWidth: 64, frameHeight: 64 });

    this.load.image('basicEnemySad', './assets/sprites/Enemigos/Enemigos_basicos/Water.png');
    this.load.spritesheet('basicEnemySad_move', './assets/sprites/Enemigos/Enemigos_basicos/Water_move.png', { frameWidth: 64, frameHeight: 64 });
    ...
    // ============================================================
    // 4. ENEMIGOS A DISTANCIA
    // ============================================================
    this.load.spritesheet('Ira_RangedEnemy', './assets/sprites/Enemigos/Enemigos_rango/Ira_RangedEnemy.png', { frameWidth: 160, frameHeight: 128 });
    this.load.spritesheet('Tristeza_RangedEnemy', './assets/sprites/Enemigos/Enemigos_rango/Tristeza_RangedEnemy.png', { frameWidth: 160, frameHeight: 128 });

    // ============================================================
    // 5. ENEMIGOS VOLADORES
    // ============================================================
    this.load.spritesheet('Ira_FlyingEnemy', './assets/sprites/Enemigos/Enemigos_voladores/Ira_FlyingEnemy.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('Tristeza_FlyingEnemy', './assets/sprites/Enemigos/Enemigos_voladores/Tristeza_FlyingEnemy.png', { frameWidth: 64, frameHeight: 64 });

    // ============================================================
    // 6. ENEMIGOS MINA
    // ============================================================
    this.load.spritesheet('Ira_MineEnemy', './assets/sprites/Enemigos/Enemigos_mina/Ira_MineEnemy.png', { frameWidth: 32, frameHeight: 32 });
    this.load.spritesheet('Tristeza_MineEnemy', './assets/sprites/Enemigos/Enemigos_mina/Tristeza_MineEnemy.png', { frameWidth: 32, frameHeight: 32 });
    ...
    this.load.spritesheet('puertairaSheet', './assets/sprites/Escena/PuertaIraSheet.png', { frameWidth: 128, frameHeight: 128 });
    ...
    this.load.spritesheet('tiles', './assets/sprites/Escena/tiles.png', { frameWidth: 32, frameHeight: 32 });
    ...
    this.load.audio('PlayerAttackHit_sound', './assets/Sounds/Player/PlayerAttackHit.wav');
